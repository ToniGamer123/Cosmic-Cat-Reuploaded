...
document.cosmicCat = {
    data: {
        ...
        i18nfolder: "https://raw.githubusercontent.com/ToniGamer123/Cosmic-Cat-Reuploaded/main/i18n/",
    ...
    const obj = {
        setTranslation: function (params) {
            return fetch(document.cosmicCat.data.i18nfolder + `${params}.json`)
                ...
                .catch((error) => {
                alert(params + " is not translated yet.\n\nContribute: https://github.com/ToniGamer123/Cosmic-Cat-Reuploaded/main/i18n/");
